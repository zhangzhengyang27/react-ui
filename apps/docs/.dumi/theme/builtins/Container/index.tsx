...
import { AiFillCheckCircle, AiFillCloseCircle, AiFillInfoCircle, AiFillWarning } from '../../icons'
...
const Container: React.FC<React.PropsWithChildren<ContainerProps>> = ({ type, title, children }) => {
    return (
        <Alert
            variant="light"
