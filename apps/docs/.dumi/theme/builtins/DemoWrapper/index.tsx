...
import { AiOutlineBug, AiOutlineCode } from '../../icons'
    ...
    return (
        <div className="demo-wrapper">
            ...
            <span className="all-code-box-controls">
                <Tooltip
                    label={<FormattedMessage id={`app.component.examples.${expandAll ? 'collapse' : 'expand'}`} />}
                >
                    <ActionIcon
                        variant="subtle"
                        size="sm"
                ...
                <Tooltip label={<FormattedMessage id={`app.component.examples.${showDebug ? 'hide' : 'visible'}`} />}>
                    <ActionIcon
                        variant="subtle"
                        size="sm"
