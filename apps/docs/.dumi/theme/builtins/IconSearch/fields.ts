...
const directionIcons: IconEntry[] = [
  ...
  { name: 'AiOutlineFastBackward', Component: AiOutlineFastBackward, category: 'direction', tags: ['fast', 'backward'] },
  ...
  { name: 'AiOutlineFullscreenExit', Component: AiOutlineFullscreenExit, category: 'direction', tags: ['fullscreen', 'exit'] },
  ...
  { name: 'AiOutlineStepBackward', Component: AiOutlineStepBackward, category: 'direction', tags: ['step', 'backward'] },
...
const suggestionIcons: IconEntry[] = [
  ...
  { name: 'AiOutlineCheckCircle', Component: AiOutlineCheckCircle, category: 'suggestion', tags: ['check', 'circle', 'success'] },
  { name: 'AiOutlineCheckSquare', Component: AiOutlineCheckSquare, category: 'suggestion', tags: ['check', 'square'] },
  { name: 'AiOutlineClose', Component: AiOutlineClose, category: 'suggestion', tags: ['close', 'x'] },
  { name: 'AiOutlineCloseCircle', Component: AiOutlineCloseCircle, category: 'suggestion', tags: ['close', 'circle'] },
  { name: 'AiOutlineCloseSquare', Component: AiOutlineCloseSquare, category: 'suggestion', tags: ['close', 'square'] },
  { name: 'AiOutlineClockCircle', Component: AiOutlineClockCircle, category: 'suggestion', tags: ['clock', 'circle', 'time'] },
  { name: 'AiOutlineExclamation', Component: AiOutlineExclamation, category: 'suggestion', tags: ['exclamation', 'warn'] },
  { name: 'AiOutlineExclamationCircle', Component: AiOutlineExclamationCircle, category: 'suggestion', tags: ['exclamation', 'circle'] },
  ...
  { name: 'AiOutlineMinusCircle', Component: AiOutlineMinusCircle, category: 'suggestion', tags: ['minus', 'circle'] },
  { name: 'AiOutlineMinusSquare', Component: AiOutlineMinusSquare, category: 'suggestion', tags: ['minus', 'square'] },
  { name: 'AiOutlinePause', Component: AiOutlinePause, category: 'suggestion', tags: ['pause'] },
  { name: 'AiOutlinePauseCircle', Component: AiOutlinePauseCircle, category: 'suggestion', tags: ['pause', 'circle'] },
  ...
  { name: 'AiOutlineQuestionCircle', Component: AiOutlineQuestionCircle, category: 'suggestion', tags: ['question', 'circle', 'help'] },
...
const editorIcons: IconEntry[] = [
  ...
  { name: 'AiOutlineBgColors', Component: AiOutlineBgColors, category: 'editor', tags: ['bg', 'colors', 'background'] },
  ...
  { name: 'AiOutlineSortAscending', Component: AiOutlineSortAscending, category: 'editor', tags: ['sort', 'ascending'] },
  { name: 'AiOutlineSortDescending', Component: AiOutlineSortDescending, category: 'editor', tags: ['sort', 'descending'] },
  ...
  { name: 'AiOutlineUnorderedList', Component: AiOutlineUnorderedList, category: 'editor', tags: ['unordered', 'list'] },
...
const logoIcons: IconEntry[] = [
  ...
  { name: 'AiFillAmazon', Component: AiFillAmazon, category: 'logo', tags: ['amazon'] },
  ...
  { name: 'AiFillDingtalk', Component: AiFillDingtalk, category: 'logo', tags: ['dingtalk'] },
  ...
  { name: 'AiFillDropbox', Component: AiFillDropbox, category: 'logo', tags: ['dropbox'] },
  ...
  { name: 'AiFillGoogle', Component: AiFillGoogle, category: 'logo', tags: ['google'] },
  { name: 'AiFillGooglePlus', Component: AiFillGooglePlus, category: 'logo', tags: ['google', 'plus'] },
  { name: 'AiFillHtml5', Component: AiFillHtml5, category: 'logo', tags: ['html5'] },
  { name: 'AiFillIe', Component: AiFillIe, category: 'logo', tags: ['ie', 'internet explorer'] },
  ...
  { name: 'AiFillMedium', Component: AiFillMedium, category: 'logo', tags: ['medium'] },
  ...
  { name: 'AiFillQq', Component: AiFillQq, category: 'logo', tags: ['qq'] },
  { name: 'AiFillReddit', Component: AiFillReddit, category: 'logo', tags: ['reddit'] },
  { name: 'AiFillSkype', Component: AiFillSkype, category: 'logo', tags: ['skype'] },
  { name: 'AiFillSlack', Component: AiFillSlack, category: 'logo', tags: ['slack'] },
  { name: 'AiFillSnapchat', Component: AiFillSnapchat, category: 'logo', tags: ['snapchat'] },
  ...
  { name: 'AiFillTelegram', Component: AiFillTelegram, category: 'logo', tags: ['telegram'] },
  ...
  { name: 'AiFillTwitter', Component: AiFillTwitter, category: 'logo', tags: ['twitter', 'x'] },
  { name: 'AiFillWechat', Component: AiFillWechat, category: 'logo', tags: ['wechat'] },
  { name: 'AiFillWeibo', Component: AiFillWeibo, category: 'logo', tags: ['weibo'] },
  { name: 'AiFillWeiboSquare', Component: AiFillWeiboSquare, category: 'logo', tags: ['weibo', 'square'] },
  { name: 'AiFillWhatsapp', Component: AiFillWhatsapp, category: 'logo', tags: ['whatsapp'] },
...
export const allIcons: IconEntry[] = [
  ...directionIcons,
  ...suggestionIcons,
  ...editorIcons,
  ...dataIcons,
