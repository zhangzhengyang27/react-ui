import { MdxCodeHighlight, MdxInfo, MdxCode, MdxLink, MdxParagraph, MdxTitle } from '../MdxShared/base';
...
export default function Polymorphic(props: PolymorphicProps) {
  return (
    <>
      <MdxTitle id="polymorphic-component">多态组件</MdxTitle>
      <MdxParagraph>
        <MdxCode>{props.component}</MdxCode> 是一个{' '}
        <MdxLink href="/docs/guides/polymorphic">多态组件</MdxLink> — 其默认根元素为{' '}
      ...
      <MdxInfo color="#3178C6">
        <MdxParagraph>
          <span style={{ fontSize: 18, fontWeight: 500 }}>TypeScript 多态组件</span>
        </MdxParagraph>
        <MdxParagraph>
          ...
          <MdxCode>React.ComponentProps&lt;div&gt;</MdxCode>。
        </MdxParagraph>
        <MdxParagraph>
        ...
        <MdxParagraph>
          ...
          <MdxLink href="/docs/guides/polymorphic">本指南</MdxLink>中介绍的{' '}
