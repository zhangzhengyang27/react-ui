...
export const TEMPLATES_DATA: Template[] = [
  ...
  },
  {
    ...
    description: 'Next.js App Router 最小模板，不包含额外工具，仅默认 Next.js 配置',
  },
  {
    type: 'next',
    name: 'next-pages-min-template',
    link: 'https://github.com/react-ui-org/next-pages-min-template',
    description: 'Next.js Pages Router 最小模板，不包含额外工具，仅默认 Next.js 配置',
  },
  {
    type: 'next',
  ...
  },
  {
    ...
    description: 'Vite 最小模板，不包含额外工具，仅默认 Vite 配置',
  },
  {
    type: 'vite',
