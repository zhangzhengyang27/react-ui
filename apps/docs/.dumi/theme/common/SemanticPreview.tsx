...
import { AiOutlineInfoCircle, AiOutlinePushpin } from '../icons'
...
function HighlightExample(props: { componentName: string; semanticName: string; itemsAPI?: string }) {
...
const getMarkClassName = (semanticKey: string) => `semantic-mark-${semanticKey}`.replace(/\./g, '-')
    ...
    return (
        <div className={styles.container} ref={containerRef}>
            <div className={styles.row} style={{ minHeight: height }}>
                <div className={clsx(styles.colWrap, padding === false && styles.colWrapPaddingLess)} style={style}>
                    {cloneNode}
                </div>
                                ...
                                <Flex direction="column" gap="sm">
                                    <Flex gap="sm" align="center" justify="space-between">
                                        ...
                                        <Flex gap="sm" align="center">
                                            ...
                                            {semantic.version && <Pill size="sm">{semantic.version}</Pill>}
                                        </Flex>
                                        ...
                                        <Flex gap="sm" align="center">
                                            <Button
                                                ...
                                                onClick={() => {
                                                    setPinSemantic(prev =>
                                                        prev === semantic.name ? null : semantic.name
                                                    )
                                                }}
                                            >
                                                <AiOutlinePushpin />
