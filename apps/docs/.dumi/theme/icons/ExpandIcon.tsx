...
const SVGIcon: React.FC<{ expanded?: boolean }> = ({ expanded }) => (
...
const ExpandIcon = React.forwardRef<HTMLSpanElement, SvgIconProps>((props, ref) => {
  const { expanded, ...rest } = props;
  return (
    <span ref={ref} {...rest} role="img" aria-label="Expand Icon">
      <SVGIcon expanded={expanded} />
    </span>
  );
});
