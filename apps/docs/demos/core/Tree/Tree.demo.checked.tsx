...
import { Checkbox, Group, RenderTreeNodePayload, Tree } from '@xiaoye-react/ui'
...
function Demo() {
    return <Tree data={data} levelOffset={23} expandOnClick={false} withLines renderNode={renderTreeNode} />
}
