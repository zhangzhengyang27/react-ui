...
title: Emotion
subtitle: Emotion
description: react-ui Emotion 文档。
---
...
建议改用 [CSS modules](/docs/styles/css-modules/)。
...
你可以使用 [Styles API](/docs/styles/styles-api/) 和 `styles` prop 配合 Emotion 为 ReactUI 组件添加样式。
...
- `theme` – [ReactUI theme 对象](/docs/theming/theme-object)
...
你可以像使用 Sass 一样使用嵌套媒体查询。在查询体内，你可以使用在 [UIProvider](/docs/theming/ui-provider) 中定义的 `theme.breakpoints`，或仅使用静态值：


### 关键帧

<code src="./emotion/demo/usage.tsx"></code>

<code src="./emotion/demo/pseudo.tsx"></code>

<code src="./emotion/demo/parameters.tsx"></code>

<code src="./emotion/demo/composition.tsx"></code>

<code src="./emotion/demo/cx.tsx"></code>

<code src="./emotion/demo/media.tsx"></code>

<code src="./emotion/demo/keyframes.tsx"></code>
