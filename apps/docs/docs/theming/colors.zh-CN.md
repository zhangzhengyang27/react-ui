...
你可以使用 [颜色生成器](/colors-generator) 基于单个值生成 10 个色阶，或安装 `@xiaoye-react/ui` 包以在应用中生成动态颜色：

<InstallScript packages="chroma-js "></InstallScript>
...
```tsx
import { generateColors } from '@xiaoye-react/ui';
import { UIProvider } from '@xiaoye-react/ui';
