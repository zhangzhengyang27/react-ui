...
const ContainerDemo: React.FC = () => {
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <Container size="md" style={{ background: 'var(--ui-color-gray-0)', padding: 16, borderRadius: 8 }}>
                <Title order={4}>size="md" 容器</Title>
                <Text size="sm">max-width 960px，水平居中</Text>
            </Container>
            <Container size="sm" style={{ background: 'var(--ui-color-gray-1)', padding: 16, borderRadius: 8 }}>
                <Title order={4}>size="sm" 容器</Title>
                <Text size="sm">max-width 720px</Text>
            </Container>
            <Container fluid style={{ background: 'var(--ui-color-gray-2)', padding: 16, borderRadius: 8 }}>
