...
import { GithubIcon, NpmIcon } from '@react-ui/dev-icons';
import { meta as globalMeta } from '@react-ui/mantine-meta';
      ...
      <div className={classes.header} data-with-tabs={withTabs || undefined}>
        ...
        {meta.license && (
          <LinkItem
            ...
            link={`${globalMeta.gitHubLinks.reactui}/blob/main/LICENSE`}
          >
            MIT
          </LinkItem>
        )}
