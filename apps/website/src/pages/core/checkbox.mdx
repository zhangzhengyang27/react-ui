...
## Checkbox with @react-ui/ui

Example of using `Checkbox` with [@react-ui/ui](/form/use-form):
...
## Checkbox.Group with @react-ui/ui

Example of using `Checkbox.Group` with [@react-ui/ui](/form/use-form):
