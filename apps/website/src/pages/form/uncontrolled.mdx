...
[form.getInputProps](/form/get-input-props/) 为受控和
...
如果你需要创建 [字段列表](/form/nested/#nested-arrays)，
...
你必须添加对 `defaultValue` prop 的支持。添加 `defaultValue` 支持的最佳方式是使用 [use-uncontrolled](/hooks/use-uncontrolled/) Hook：
