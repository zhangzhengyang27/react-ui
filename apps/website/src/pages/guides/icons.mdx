...
# Icon libraries with ReactUI

You can use any icon library with ReactUI components. The most popular options are:
...
[Phosphor icons](https://phosphoricons.com/) are used in ReactUI demos, documentation,
