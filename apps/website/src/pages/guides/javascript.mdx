...
## Is it possible to use ReactUI with JavaScript?
...
All demos in ReactUI documentation are written in TypeScript. In most cases, there's no difference between
...
## Should ReactUI be used with JavaScript?

We recommend using ReactUI with TypeScript. It doesn't require deep knowledge of TypeScript
...
help you during migration to new versions of ReactUI – you'll get type errors when props/components
that you have in your code are removed/renamed/changed.

If you're not familiar with TypeScript yet, using ReactUI with TypeScript will be a great opportunity
