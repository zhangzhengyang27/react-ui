...
所有 ReactUI 组件都需要在组件树中提供 [UIProvider](/theming/ui-provider/)。
要在测试中的组件树添加 [UIProvider](/theming/ui-provider/)，请创建一个[自定义 render](https://testing-library.com/docs/react-testing-library/setup/#custom-render)函数：
