...
本指南将帮助你在项目中配置 [Jest](https://jestjs.io/) 和 [React Testing Library](https://testing-library.com/docs/react-testing-library/intro)。
注意，本指南仅涵盖可应用于任何框架的通用逻辑，不包含 [Jest](https://jestjs.io/) 和 [React Testing Library](https://testing-library.com/docs/react-testing-library/intro) 的初始设置，因为具体步骤会因你使用的框架而异。
