...
All ReactUI components require [MantineProvider](/theming/mantine-provider/) to be present in the component tree.
...
Most ReactUI components depend on browser APIs like `window.matchMedia` or `ResizeObserver`.
...
You can find testing examples in ReactUI GitHub Discussions:

- [How can I test Modal/Drawer/Popover components?](https://github.com/xiaoye/react-ui/discussions)
- [How can I test Select/MultiSelect components?](https://github.com/xiaoye/react-ui/discussions)
