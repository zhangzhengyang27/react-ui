...
ReactUI 提供适合 LLM 的文档，帮助 **Cursor**、**Windsurf**、**GitHub Copilot**、**ChatGPT** 和 **Claude** 等 AI 工具理解和使用 ReactUI 组件库。

`llms.txt` 文档会随每个 ReactUI 版本更新。
...
如果你发现 LLM 文档有任何问题或有改进建议，请在我们的 GitHub 仓库[提交 issue](https://github.com/xiaoye/react-ui/issues)。
