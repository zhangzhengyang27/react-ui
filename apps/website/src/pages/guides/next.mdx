...
在 `pages/_app.tsx` 文件中添加样式导入和 [UIProvider](/theming/ui-provider)：
...
在 `app/layout.tsx` 文件中添加 [UIProvider](/theming/ui-provider)、[ColorSchemeScript](/theming/color-schemes)
和样式导入：
