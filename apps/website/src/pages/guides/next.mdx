...
// All packages except `@react-ui/hooks` require styles imports
...
All ReactUI components require context to support [default props](/theming/default-props)
and [Styles API](/styles/styles-api). ReactUI components cannot be used as server components.
...
If you have any issues with ReactUI in your Next.js application, please check the
[GitHub Discussions](https://github.com/xiaoye/react-ui/discussions) that covers
