...
This guide will help you get familiar with the types that the `@react-ui/ui` package exports.
...
All ReactUI components export namespaces with related types. For example, [Button](/core/button)
component props can be accessed as `Button.Props`:

```tsx
import {  Button } from '@react-ui/ui';

// Same as `import type { ButtonProps } from '@react-ui/ui';`
...
features. It replaces the native element's `style` prop with ReactUI's [style prop](/styles/style) and
...
// Removes all ReactUI component props from React component props
