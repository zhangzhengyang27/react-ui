...
in the `jsdom` environment but are required by some ReactUI components.
...
You can find an example with a full Vitest setup in [react-ui-vite-template](https://github.com/react-ui-org/vite-template).
