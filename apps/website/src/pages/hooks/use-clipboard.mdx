import { UseClipboardDemos } from '@react-ui/docs-demos';
...
The `UseClipboardOptions` and `UseClipboardReturnValue` types are exported from the `@react-ui/hooks` package;
