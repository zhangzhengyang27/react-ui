import { UseCollapseDemos, UseHorizontalCollapseDemos } from '@react-ui/docs-demos';
...
The `UseCollapseInput`, `UseCollapseState`, and `UseCollapseReturnValue` types are exported from the `@react-ui/hooks` package;
