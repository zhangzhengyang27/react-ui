import { UseFullscreenDemos } from '@react-ui/docs-demos';
...
The `UseFullscreenElementReturnValue` and `UseFullscreenDocumentReturnValue` types are exported from the `@react-ui/hooks` package;
