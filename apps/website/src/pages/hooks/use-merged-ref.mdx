...
当你想同时使用 [use-click-outside](/hooks/use-click-outside/) 和 [use-focus-trap](/hooks/use-focus-trap/) Hook，
并且自己也想获取一个 ref 时：
...
只有在你无法使用 `use-merged-ref` 时才使用它。注意，`mergeRefs` 无法与 [use-focus-trap](/hooks/use-focus-trap/) Hook 正确配合，
