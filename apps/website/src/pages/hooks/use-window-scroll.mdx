import { UseWindowScrollDemos } from '@react-ui/docs-demos';
...
The `UseWindowScrollTo`, `UseWindowScrollPosition`, and `UseWindowScrollReturnValue` types are exported from `@react-ui/hooks`;
