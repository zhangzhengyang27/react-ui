import { DayViewDemos, MonthViewDemos, ScheduleDemos, WeekViewDemos, YearViewDemos } from '@react-ui/docs-demos';
...
`@react-ui/schedule` supports recurring events via [RFC 5545](https://datatracker.ietf.org/doc/html/rfc5545)
