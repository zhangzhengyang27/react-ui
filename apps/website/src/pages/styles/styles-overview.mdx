...
This guide will help you understand how to apply styles to ReactUI and custom components.
...
`background-color` and `border` properties. In most cases, changing component props is the most optimal way to customize ReactUI components.
...
[Style prop](/styles/style/) is supported by all ReactUI components and allows setting
...
[CSS modules](/styles/css-modules/) is the recommended way of applying most of the styles to ReactUI components.
...
You can reference ReactUI [theme](/theming/theme-object/) values in any styles with
