...
this approach generates static CSS that is never re-evaluated. 99% of ReactUI component
...
You can apply styles to HTML elements with the `className` prop and to ReactUI components with the `className`
