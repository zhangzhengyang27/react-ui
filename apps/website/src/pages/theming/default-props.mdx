...
You can define default props for every ReactUI component by setting `theme.components`.
...
All ReactUI components have a `withProps` static function that can be used to
