...
By default, ReactUI uses system fonts. This means that different devices will display components based on the available font.
...
The `theme.fontSizes` property defines font-size values for all ReactUI components:
