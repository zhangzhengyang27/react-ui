import { CarouselDemos } from '@react-ui/docs-demos';
...
<InstallScript packages="embla-carousel@^8.5.2 embla-carousel-react@^8.5.2 @react-ui/ui" />
...
`@react-ui/ui` package is based on [embla carousel](https://www.embla-carousel.com/):
...
Note that plugins are not installed with the `@react-ui/ui` package and you will need to
