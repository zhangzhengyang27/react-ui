...
describe('@react-ui/schedule/validate-event', () => {
  ...
  it('throws error for invalid start date', () => {
    ...
    expect(() => validateEvent(invalidEvent)).toThrow(
      `[@react-ui/schedule] Invalid start date for event id: ${invalidEvent.id}`
    );
  });
  ...
  it('throws error for invalid end date', () => {
    ...
    expect(() => validateEvent(invalidEvent)).toThrow(
      `[@react-ui/schedule] Invalid end date for event id: ${invalidEvent.id}`
    );
  });
  ...
  it('throws error when end date is before start date', () => {
    ...
    expect(() => validateEvent(invalidEvent)).toThrow(
      `[@react-ui/schedule] Event end date is before start date for event id: ${invalidEvent.id}`
    );
  });
