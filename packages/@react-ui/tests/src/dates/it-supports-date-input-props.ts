...
import { expectValue, clickInput, clickControl, getInputValue, expectOpenedPopover, expectNoModal, expectNoPopover, expectOpenedModal } from './date-input-test-helpers';

function itSupportsDateInputProps(options, name = "supports date input props") {
  describe(name, () => {
    it('supports uncontrolled state (type="default")', async () => {
      const { container } = render(
        /* @__PURE__ */ jsx(options.component, { ...options.props, placeholder: "test-placeholder" })
      );
    ...
    it('supports uncontrolled state (type="range")', async () => {
      const { container } = render(
        /* @__PURE__ */ jsx(options.component, { ...options.props, type: "range", placeholder: "test-placeholder" })
      );
      expectValue(container, "test-placeholder");
      await clickInput(container);
      await clickControl(container, 0);
    ...
    it('supports uncontrolled state (type="multiple")', async () => {
      const { container } = render(
        /* @__PURE__ */ jsx(options.component, { ...options.props, type: "multiple", placeholder: "test-placeholder" })
      );
      expectValue(container, "test-placeholder");
      await clickInput(container);
      await clickControl(container, 0);
    ...
    it('toggles modal when input is clicked (dropdownType="modal")', async () => {
      const { container } = render(/* @__PURE__ */ jsx(options.component, { ...options.props, dropdownType: "modal" }));
      await clickInput(container);
    ...
    it('closes dropdown when dates range is selected (type="range")', async () => {
      const { container } = render(/* @__PURE__ */ jsx(options.component, { ...options.props, type: "range" }));
      expectNoPopover(container);
      await clickInput(container);
      expectOpenedPopover(container);
      await clickControl(container, 0);
    ...
    it('does not close dropdown when date is selected (type="multiple")', async () => {
      const { container } = render(/* @__PURE__ */ jsx(options.component, { ...options.props, type: "multiple" }));
      expectNoPopover(container);
      await clickInput(container);
      expectOpenedPopover(container);
      await clickControl(container, 0);
    ...
    it('does not close dropdown when date is selected if closeOnChange is set to false (type="default")', async () => {
      const { container } = render(
        /* @__PURE__ */ jsx(options.component, { ...options.props, type: "default", closeOnChange: false })
      );
      expectNoPopover(container);
      await clickInput(container);
      expectOpenedPopover(container);
    ...
    it('does not close dropdown when dates range is selected if closeOnChange is set to false (type="range")', async () => {
      const { container } = render(
        /* @__PURE__ */ jsx(options.component, { ...options.props, type: "range", closeOnChange: false })
      );
      expectNoPopover(container);
      await clickInput(container);
      expectOpenedPopover(container);
    ...
    it('supports controlled state (type="default")', async () => {
      const spy = jest.fn();
      const { container } = render(
        /* @__PURE__ */ jsx(options.component, { ...options.props, type: "default", value: "2022-04-11", onChange: spy })
      );
    ...
    it('does not allow to deselect value if allowDeselect is not set (type="default")', async () => {
      const { container } = render(
        /* @__PURE__ */ jsx(options.component, { ...options.props, type: "default", placeholder: "test-placeholder" })
      );
      expectValue(container, "test-placeholder");
      await clickInput(container);
      await clickControl(container, 0);
    ...
    it("does not open popover if readOnly prop is set", async () => {
      const { container } = render(/* @__PURE__ */ jsx(options.component, { ...options.props, readOnly: true }));
      expectNoPopover(container);
      expectNoModal(container);
      await clickInput(container);
      expectNoPopover(container);
    ...
    it("does not open modal if readOnly prop is set", async () => {
      const { container } = render(
        /* @__PURE__ */ jsx(options.component, { ...options.props, readOnly: true, dropdownType: "modal" })
      );
      expectNoPopover(container);
      expectNoModal(container);
      await clickInput(container);
...
export { itSupportsDateInputProps };
