...
RichTextEditorControl.displayName = '@react-ui/tiptap/RichTextEditorControl';
...
RichTextEditorControlBase.displayName = '@react-ui/tiptap/RichTextEditorControlBase';
...
export function createControl({
  ...
  Control.displayName = `@react-ui/tiptap/${label}`;
