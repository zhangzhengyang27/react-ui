...
function itSupportsSystemProps(options) {
  describe("supports system properties", () => {
    const splittedDisplayName = options.displayName ? options.displayName.split("/") : [];
    const predictedProviderName = options.displayName ? splittedDisplayName[splittedDisplayName.length - 1] : void 0;
    ...
    typeof providerName === "string" && options.providerName !== null && itSupportsProviderDefaultProps({ ...options, providerName });
