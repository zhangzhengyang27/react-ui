...
function itSupportsMonthProps(options, name = "supports month props") {
  describe(name, () => {
    ...
    it("renders correct days when firstDayOfWeek is set", () => {
      const { container } = render(/* @__PURE__ */ jsx(options.component, { ...options.props, firstDayOfWeek: 6 }));
      const days = getDays(container);
    ...
    it("renders correct days when firstDayOfWeek is set on DatesProvider", () => {
      const { container } = render(
        /* @__PURE__ */ jsx(DatesProvider, { settings: { firstDayOfWeek: 6 }, children: /* @__PURE__ */ jsx(options.component, { ...options.props }) })
      );
      const days = getDays(container);
      expect(days).toHaveLength(42);
      expect(days[0].textContent).toBe("26");
    ...
    it("detects weekends correctly with custom weekendDays value", () => {
      const { container } = render(/* @__PURE__ */ jsx(options.component, { ...options.props, weekendDays: [3, 4] }));
      const days = getDays(container);
    ...
    it("detects weekends correctly with custom weekendDays value on DatesProvider", () => {
      const { container } = render(
        /* @__PURE__ */ jsx(DatesProvider, { settings: { weekendDays: [3, 4] }, children: /* @__PURE__ */ jsx(options.component, { ...options.props }) })
      );
      const days = getDays(container);
      expect(days[7]).not.toHaveAttribute("data-weekend");
      expect(days[8]).not.toHaveAttribute("data-weekend");
    ...
    it("supports minDate", () => {
      const { container } = render(/* @__PURE__ */ jsx(options.component, { ...options.props, minDate: "2022-04-10" }));
      const days = getDays(container);
    ...
    it("supports maxDate", () => {
      const { container } = render(/* @__PURE__ */ jsx(options.component, { ...options.props, maxDate: "2022-04-22" }));
      const days = getDays(container);
    ...
    it("supports renderDay", () => {
      const { container } = render(
        /* @__PURE__ */ jsx(options.component, { ...options.props, renderDay: (date) => dayjs(date).year() })
      );
      const days = getDays(container);
      days.forEach((day) => {
    ...
    it("supports hideOutsideDates", () => {
      const { container } = render(/* @__PURE__ */ jsx(options.component, { ...options.props, hideOutsideDates: true }));
      const days = getDays(container);
      expect(days).toHaveLength(35);
    ...
    it("supports hideWeekdays", () => {
      render(/* @__PURE__ */ jsx(options.component, { ...options.props, hideWeekdays: true }));
