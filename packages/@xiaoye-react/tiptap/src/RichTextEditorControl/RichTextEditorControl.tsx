...
RichTextEditorControl.displayName = '@xiaoye-react/tiptap/RichTextEditorControl';
...
RichTextEditorControlBase.displayName = '@xiaoye-react/tiptap/RichTextEditorControlBase';
...
export function createControl({
  ...
  Control.displayName = `@xiaoye-react/tiptap/${label}`;
