...
export const HueSlider = factory<HueSliderFactory>((props: HueSliderProps, _ref) => {
    const { value, onChange, onChangeEnd, ...others } = useProps('HueSlider', defaultProps, props)
