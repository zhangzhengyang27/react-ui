...
const varsResolver = createVarsResolver<TableScrollContainerFactory>((_, { minWidth, maxHeight, type }) => ({
    scrollContainer: {
...
export namespace TableScrollContainer {
    ...
    export type StylesNames = TableScrollContainerStylesNames
    export type CssVariables = TableScrollContainerCssVariables
