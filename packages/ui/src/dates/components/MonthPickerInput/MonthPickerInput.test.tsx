import { __InputStylesNames } from '../../../components/Input/index';
import { inputDefaultProps, inputStylesApiSelectors, render, tests } from '@xiaoye-react/tests';
import { datesTests, expectValue } from '@xiaoye-react/tests/dates';
...
describe('@xiaoye-react/dates/MonthPickerInput', () => {
  ...
  tests.itSupportsSystemProps<MonthPickerInputProps, __InputStylesNames>({
    ...
    displayName: '@xiaoye-react/dates/MonthPickerInput',
