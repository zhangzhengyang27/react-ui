...
export function useEmotionCache() {
  ...
  if (cache === null) {
    throw new Error(
      'Emotion cache is not available in context, make sure that you have UIEmotionProvider in the component tree'
    );
  }
...
export const UIEmotionProvider = withEmotionCache<EmotionCacheProviderProps>(
  ({ children, cache }, ctx) => (
